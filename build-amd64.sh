#!/bin/bash
# docker push bsbdock/nexus:1.3.0.1_linux-amd64
...
docker build --build-arg CACHEBUST=$(date +%s) --tag bsbdock/nexus:1.3.0.1_linux-amd64 -f Dockerfile_nexus1.3.0.1_linux-amd64 .
docker tag bsbdock/nexus:1.3.0.1_linux-amd64 bsbdock/nexus
cd ..
