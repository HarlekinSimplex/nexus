#!/bin/bash
# docker push bsbdock/nexus:1.2.0_linux-amd64
...
docker build --tag bsbdock/nexus:1.2.0_linux-amd64 -f Dockerfile_nexus1.2.0_linux-amd64 .
docker tag bsbdock/nexus:1.2.0_linux-amd64 bsbdock/nexus
cd ..
