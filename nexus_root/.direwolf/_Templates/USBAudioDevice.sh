...
#DIREWOLF_<dw-instance>_DUAL_SOUND_CARD=No
#DIREWOLF_<dw-instance>_INPUT_SOUND_CARD=1
#DIREWOLF_<dw-instance>_OUTPUT_SOUND_CARD=1
#
# Direwolf default amixer content values
#DIREWOLF_<dw-instance>_MIC_CAPTURE_SWITCH=on
#DIREWOLF_<dw-instance>_MIC_CAPTURE_VOLUME=80%
#DIREWOLF_<dw-instance>_AUTO_GAIN_CONTROL=off
#DIREWOLF_<dw-instance>_MIC_PLAYBACK_SWITCH=off
#DIREWOLF_<dw-instance>_MIC_PLAYBACK_VOLUME=0%
#DIREWOLF_<dw-instance>_SPEAKER_PLAYBACK_SWITCH=on
#DIREWOLF_<dw-instance>_SPEAKER_PLAYBACK_VOLUME=80%

# Set sound card default
DIREWOLF_SOUND_CARD="${DIREWOLF_$1_SOUND_CARD:-1}"
# Check if we have a dual device configuration set up
# Default is 'No'
DIREWOLF_DUAL_SOUND_CARD="${DIREWOLF_$1_DUAL_SOUND_CARD:-No}"
# Set dual device config defaults
DIREWOLF_INPUT_SOUND_CARD="${DIREWOLF_$1_INPUT_SOUND_CARD:-$DIREWOLF_SOUND_CARD}"
DIREWOLF_OUTPUT_SOUND_CARD="${DIREWOLF_$1_OUTPUT_SOUND_CARD:-$DIREWOLF_SOUND_CARD}"
# Set Input defaults
DIREWOLF_MIC_CAPTURE_SWITCH="${DIREWOLF_$1_MIC_CAPTURE_SWITCH:-on}"
DIREWOLF_MIC_CAPTURE_VOLUME="${DIREWOLF_$1_MIC_CAPTURE_VOLUME:-80%}"
DIREWOLF_AUTO_GAIN_CONTROL="${DIREWOLF_$1_AUTO_GAIN_CONTROL:-off}"
DIREWOLF_MIC_PLAYBACK_SWITCH="${DIREWOLF_$1_MIC_PLAYBACK_SWITCH:-off}"
DIREWOLF_MIC_PLAYBACK_VOLUME="${DIREWOLF_$1_MIC_PLAYBACK_VOLUME:-0%}"
# Set Output defaults
DIREWOLF_SPEAKER_PLAYBACK_SWITCH="${DIREWOLF_$1_SPEAKER_PLAYBACK_SWITCH:-on}"
DIREWOLF_SPEAKER_PLAYBACK_VOLUME="${DIREWOLF_$1_SPEAKER_PLAYBACK_VOLUME:-80%}"
...
echo -e ""
echo -e "${LIGHT_BLUE}Sound input channel parameters for direwolf instance $1:${NC}"
