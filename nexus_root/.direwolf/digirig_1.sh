...
#DIREWOLF_DIGIRIG_1_MIC_CAPTURE_VOLUME=80%
#DIREWOLF_DIGIRIG_1_AUTO_GAIN_CONTROL=off
#DIREWOLF_DIGIRIG_1_MIC_PLAYBACK_SWITCH=off
#DIREWOLF_DIGIRIG_1_MIC_PLAYBACK_VOLUME=0%
#DIREWOLF_DIGIRIG_1_SPEAKER_PLAYBACK_SWITCH=on
#DIREWOLF_DIGIRIG_1_SPEAKER_PLAYBACK_VOLUME=80%
