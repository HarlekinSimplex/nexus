...
#DIREWOLF_VOX_CHARLIE_1_SOUND_CARD=Charlie
#DIREWOLF_VOX_CHARLIE_1_DUAL_SOUND_CARD=No
#DIREWOLF_VOX_CHARLIE_1_INPUT_SOUND_CARD=Charlie
#DIREWOLF_VOX_CHARLIE_1_OUTPUT_SOUND_CARD=Charlie
#
# Direwolf default amixer content values
#DIREWOLF_VOX_CHARLIE_1_MIC_CAPTURE_SWITCH=on
#DIREWOLF_VOX_CHARLIE_1_MIC_CAPTURE_VOLUME=80%
#DIREWOLF_VOX_CHARLIE_1_AUTO_GAIN_CONTROL=off
#DIREWOLF_VOX_CHARLIE_1_MIC_PLAYBACK_SWITCH=off
#DIREWOLF_VOX_CHARLIE_1_MIC_PLAYBACK_VOLUME=0%
#DIREWOLF_VOX_CHARLIE_1_SPEAKER_PLAYBACK_SWITCH=on
#DIREWOLF_VOX_CHARLIE_1_SPEAKER_PLAYBACK_VOLUME=80%
