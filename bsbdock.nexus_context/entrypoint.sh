...
export NEXUS_SHORTPOLL="${NEXUS_LONGPOLL:-10}"
export NEXUS_TIMEOUT="${NEXUS_TIMEOUT:-43200}"
export NEXUS_POSTMASTER_CONFIG="${NEXUS_POSTMASTER_CONFIG:-{\"ticks\": [0, 10, 20, 30, 50, 80, 130], \"poll\": 1}}"

NEXUS_POSTMASTER_CONFIG =
